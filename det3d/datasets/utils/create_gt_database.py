...
def create_groundtruth_database(
    ...
    **kwargs,
    ...
    elif dataset_class_name in ["SemanticKITTI"]:
        if db_path is None:
            db_path = root_path / "gt_database_single_sweep.pkl"
        if dbinfo_path is None:
            dbinfo_path = root_path / "dbinfos_train_single_sweep.pkl"
    else:
    ...
    elif dataset_class_name == "SemanticKITTI":
        point_features = 4
    else:
        raise NotImplementedError()
